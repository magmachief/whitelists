...
-- Features: Auto Pass, AI-Based Fallback, Shift Lock, Mobile Support, Anti‑Slippery, Hitbox ESP Toggle.
-----------------------------------------------------
...
local HitboxESPEnabled = false -- Toggle for Hitbox ESP
