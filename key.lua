...
-----------------------------------------------------
-- PC View Functionality (simulate PC camera view)
-----------------------------------------------------
...
-----------------------------------------------------
-- Legacy Friction Module (Not used)
-----------------------------------------------------
...
AutomatedTab:AddToggle({Name="PC View",Info="Enable PC camera view for better oversight",Default=false,Callback=function(v)
  enablePCView(v)
end})
...
print("Bomb AI & Anti‑Slippery system loaded. Menu, toggles, shiftlock, and camera features active.")
return {}